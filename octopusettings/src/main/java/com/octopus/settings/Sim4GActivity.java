...
import com.octopus.settings.utils.MobileInfoUtil;
...
public class Sim4GActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            Method method = clazz.getDeclaredMethod("getNeighboringCellInfo");
            method.setAccessible(true);
            Object object = method.invoke(tel);
            if (object != null) {
                text.append("Ncell number:").append(((List<NeighboringCellInfo>)object).size()).append("\n");
            }
            text.append("getNeighboringCellInfo:").append("" + object).append("\n");
        } catch (Exception e) {
            FlyLog.e(e.toString());
        }

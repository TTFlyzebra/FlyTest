...
import android.octopu.IOcProcessService;
 ...
 * Date: 21-3-24 下午5:42
 */
public class OcProcessService extends IOcProcessService.Stub implements Runnable {
    private Context mContext;
    private ActivityManager am;
    private static final Object mLock = new Object();
    private static List<String> whiteList = new ArrayList<>();
    public static OcProcessService ocProcessService;
    private static final HandlerThread mTaskThread = new HandlerThread("OcProcess");
    ...
    public static OcProcessService getInstance() {
        return ocProcessService;
    }

    public OcProcessService(Context context) {
        mContext = context;
    ...
    @Override
    public void notifyProcessStatu(String packName, int statu) throws RemoteException {
